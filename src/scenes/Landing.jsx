      ...
      <div className="z-30 basis-2/5 mt-12 md:mt-32">
        ...
        >
          ...
          <p className="mt-10 mb-7 text-sm text-center md:text-start">
            Albert Einstein fue un físico alemán que nació en Ulm, Alemania, en
            1879, posterior que a temprana edad su familia se trasladó a la
            ciudad de Múnich, cursó su primera enseñanza en el instituto
            católico de Múnich.
          </p>
        </motion.div>
